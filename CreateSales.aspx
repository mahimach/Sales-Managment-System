<%@ Page Title="" Language="C#" MasterPageFile="~/Mainmaster.Master" AutoEventWireup="true" CodeBehind="CreateSales.aspx.cs" Inherits="SALES_SYSTEM.CreateSales" %>
            ...
            <div class="input-group">
                <div class="form-inline">    
                    ...
                    <table border="0" cellpadding="5" cellspacing="5" class="table bg-success ">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox runat="server" ID="txtStudentId"  placeholder="User Name"   CssClass="form-control"/>
                            </td>
                            <td>
                                 <asp:TextBox runat="server" ID="txtStudentName"  placeholder="Password"  CssClass="form-control"/>
                            </td>
                            <td>
                                <asp:Button Text="Add User" runat="server" ID="btnAdd" 
                                    CssClass="btn btn-sm btn-primary" OnClick="btnAdd_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
